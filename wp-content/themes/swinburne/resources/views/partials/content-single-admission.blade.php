<?php 
$query_info = get_queried_object();

$custom_template = get_field('custom_template', $query_info);
if ($custom_template == 'yes') {?>
<div class="custom-detail news-page">
    {!! the_content() !!}
</div>
        ...
        <div class="row">
            <div class="col-lg-9">
                <div class="main-content-detail main-news">
                    ...
                    <div class="remove_list">{!! the_content() !!}</div>
                    <div class="university-area list-post-news">
                        <div class="list-posts-about">
                            <div class="row">
                                @php
                                @endphp
                                @if ($query_admission->have_posts())
                                    @while ($query_admission->have_posts())
                                        @php
                                            $query_admission->the_post();
                                        @endphp
                                        <div class="col-lg-4 col-sm-6 col-12">
                                            <div class="single-post-about">
                                                ...
                                                <div class="content-posts-about">
                                                    <h4><a href="{{ get_the_permalink() }}">{{ get_the_title() }}</a>
                                                    </h4>
