...
<div class="about-page">
    <div class="banner-about fixheight" style="background-image: url('{!! pll_current_language('slug')==='vi' ? get_option('certificates_vi') : get_option('certificates') !!}');">
            ...
            <div class="main-about">
                ...
                <div class="list-posts-about">
                    <div class="row">
                        @php
                        @endphp
                        @if ($query_diplomas->have_posts())
                        @while ($query_diplomas->have_posts())
                        @php
                        $query_diplomas->the_post();
                        @endphp
