...
@section('content')
    ...
    <div class="banner-study fixheight" style="background-image: url('{{ get_option('study_with_us') }}');">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="single-unit-detail">
                                            ...
                                            <div class="apply-now apply_pd">
                                                <a href="{!! pll_current_language('slug') === 'vi' ? site_url('/phieu-dang-ky') : site_url('/registration-form') !!}"><i class="fa fa-paper-plane"
                                                        aria-hidden="true"></i> {!! pll_current_language('slug') === 'vi' ? 'ĐĂNG KÝ NHẬP HỌC' : 'ENQUIRY' !!}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
