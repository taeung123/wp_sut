...
<div class="about-page">
    <div class="banner-about fixheight" style="background-image: url('{!! pll_current_language('slug')==='vi' ? get_option('double_degrees_vi') : get_option('double_degrees') !!}');">
            ...
            <div class="main-about">
                ...
                <div class="list-posts-about">
                    <div class="row">
                        @php
                        @endphp
                        @if ($query_degrees->have_posts())
                        @while ($query_degrees->have_posts())
                        @php
                        $query_degrees->the_post();
                        @endphp
