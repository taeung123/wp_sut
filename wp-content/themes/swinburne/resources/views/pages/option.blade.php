...
<div class="about-page">
    <div class="banner-about fixheight" style="background-image: url('{!! pll_current_language('slug')==='vi' ? get_option('study_options_vi') : get_option('study_options') !!}');">
            ...
            <div class="main-about">
                ...
                <div class="list-posts-about">
                    <div class="row">
                        @php
                        @endphp
                        @if ($query_option->have_posts())
                        @while ($query_option->have_posts())
                        @php
                        $query_option->the_post();
                        @endphp
                            ...
                            <div class="single-post-about">
                               @php
                                ...
                                <div class="content-posts-about">
                                    <h2><a href="{{ $get_field === NULL || $get_field === '' ? get_permalink() : $get_field }}">{{get_the_title()}}</a></h2>
