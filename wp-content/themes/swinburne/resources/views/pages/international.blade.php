...
<div class="about-page">
    <div class="banner-about fixheight" style="background-image: url('{!! pll_current_language('slug')==='vi' ? get_option('International_vi') : get_option('International') !!}');">
            ...
            <div class="main-about">
                ...
                <div class="list-posts-about">
                    <div class="row">
                        @php
                        @endphp
                        @if ($query_international_post->have_posts())
                        @while ($query_international_post->have_posts())
                        @php
                        $query_international_post->the_post();
                        @endphp
