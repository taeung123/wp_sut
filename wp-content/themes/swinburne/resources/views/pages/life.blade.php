...
<div class="about-page">
    <div class="banner-about fixheight" style="background-image: url('{!! pll_current_language('slug')==='vi' ? get_option('life_fpt_vi') : get_option('life_fpt') !!}');">
            ...
            <div class="main-about">
                ...
                <div class="list-posts-about">
                    <div class="row">
                        @php
                        @endphp
                        @if ($query_life->have_posts())
                        @while ($query_life->have_posts())
                        @php
                        $query_life->the_post();
                        @endphp
